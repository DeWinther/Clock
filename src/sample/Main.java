...
public class Main extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        primaryStage.setScene(new Scene(root, 470,402));

        // add background image
        ImageView background;
        Image img = new Image("sample/DCBackground.png");
        ImageView imgView = new ImageView(img);
        imgView.setFitHeight(410);
        imgView.setFitWidth(480);

        // background = new ImageView(new Image(getClass().getResource("Clock/src/sample/DCBackground.png")

        // add digital clock
        clock = new Clock(Color.RED, Color.rgb(50,50,50));
        clock.setLayoutX(45);
        clock.setLayoutY(186);
        clock.getTransforms().add(new Scale(0.83f, 0.83f, 0, 0));
        // add background and clock to sample
        root.getChildren().addAll(imgView, clock);
    }
